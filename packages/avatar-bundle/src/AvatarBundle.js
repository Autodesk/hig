...
class AvatarBundle extends Component {
  ...
  render() {
    ...
    if (showOverflowCount && avatars.length > 3) {
      const overflowAmt = avatars.length - 3;
      if (overflowAmt <= 99) {
          ...
          >
            <span
              className={cx(
                ...
                css(styles(resolvedRoles).avatarWrapper0)
              )}
            >
            ...
            {avatars.length > 1 && (
              <span
                className={cx(
                  css(styles(resolvedRoles).avatarWrapper),
                  css(styles(resolvedRoles).avatarWrapper1)
                )}
              >
            ...
            {avatars.length > 2 &&
              overflow === 0 && (
                <span
                  className={cx(
                    css(styles(resolvedRoles).avatarWrapper),
                    css(styles(resolvedRoles).avatarWrapper2)
                  )}
                >
