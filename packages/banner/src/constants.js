const constants = themeData => {
  ...
  const bannerDismissIconPadding = `calc((${
    base.bannerDismissIconButtonWidth
  } - ${base.bannerDismissIconWidth}) / 2)`;
  const bannerDismissSpacingRightInteractive = base.bannerActionSpacingX;
  const bannerContentSpacingY = `calc((${base.bannerWrapperMinHeight} - ${
    base.bannerMessageFontSize
  }) / 2)`;
  ...
  return Object.assign(base, {
    ...
    bannerDismissPaddingRight: `calc(${
      base.bannerDismissSpacingRight
    } - ${bannerDismissIconPadding})`,
    bannerDismissPaddingRightInteractive: `calc(${bannerDismissSpacingRightInteractive} - ${
      base.bannerDismissIconPadding
    })`,
    bannerDismissPaddingTopWrapping: `calc(${bannerContentSpacingY} - ${
      base.bannerDismissIconPadding
    })`,
    bannerInteractionsWrapperPaddingY: `calc(${bannerContentSpacingY} - ${
      base.bannerActionPaddingY
    })`,
    bannerMessagePaddingY: `calc((${base.bannerWrapperMinHeight} - ${
      base.bannerMessageLineHeight
    }) / 2)`
  });
};
