...
describe("notification-flyout/behaviors/parseNotifications", () => {
  [
    ...
    {
      desc: "returns notifications when given an array of Notification elements",
      input: [
    ...
    {
      desc: "returns notifications when given a single <Notification /> component as children",
