...
storiesOf("Spacer", module).addWithInfo("Basic Spacer", "", () => (
  <div>
    <div key="a" style={spacerStyle}>
      ...
      >
        <Slot key="foo">
          <p key="1" style={paraStyle} className="spacer_para">
            STACK M WIDTH
          </p>
          <p key="2" style={paraStyle} className="spacer_para">
            STACK XL INSET
          </p>
        </Slot>
      </Spacer>
    ...
    <div>
      ...
      >
        <Slot key="bar">
          <span key="1" style={paraStyle} className="spacer_para">
            STACK M WIDTH
          </span>
          <span>&nbsp;</span>
          <span key="2" style={paraStyle} className="spacer_para">
            STACK XL INSET
          </span>
        </Slot>
      </Spacer>
