    ...
    <GlobalNav>
      <TopNav logo={logo}>
        ...
        >
          ...
          <Account
            ...
            onClick={action("clicked account")}
          />
          <Project image={project3} label="Oakland Medical Center" active />
          <Project
            image={project4}
      ...
      <Slot>
        <p>
          ...
          post-ironic hashtag. Hoodie dreamcatcher enamel pin lumbersexual
          before they sold out, authentic selvage tumblr vinyl. Hot chicken
          chillwave coloring book fixie vice venmo echo park portland. Tote bag
          master cleanse cronut banjo banh mi pitchfork, celiac photo booth.
        </p>
      </Slot>
    </GlobalNav>
  ))
