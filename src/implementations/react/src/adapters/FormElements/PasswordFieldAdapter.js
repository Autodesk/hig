...
function PasswordFieldAdapter(props) {
  return (
    <HIGAdapter {...props} displayName="PasswordField" HIGConstructor={HIG.PasswordField}>
      {adapterProps => (
        <div>
          <ControlsProp
            listener="onInput"
          ...
          <MapsEventListener listener="onPasswordRevealButtonClick" handler={props.onPasswordRevealButtonClick} {...adapterProps} />
          <MapsEventListener listener="onPasswordHideButtonClick" handler={props.onPasswordHideButtonClick} {...adapterProps} />
          ...
          <MapsPropToMethod value={props.revealPassword} {...adapterProps}>
            {(instance, value) => value ? instance.revealPassword() : instance.hidePassword()}
          </MapsPropToMethod>
          <MapsPropToMethod value={props.showPasswordHideButton} {...adapterProps}>
            {(instance, value) => value ? instance.showPasswordHideButton() : instance.hidePasswordHideButton()}
          </MapsPropToMethod>
          <MapsPropToMethod value={props.showPasswordRevealButton} {...adapterProps}>
            {(instance, value) => value ? instance.showPasswordRevealButton() : instance.hidePasswordRevealButton()}
          </MapsPropToMethod>
        </div>
      )}
    </HIGAdapter>
