...
import ProjectAdapter from './NewProjectAdapter';
...
function ProjectAccountSwitcherAdapter(props) {
  ...
  return (
    <HIGAdapter name="ProjectAccountSwitcher" HIGConstructor={HIG.GlobalNav._partials.TopNav._partials.ProjectAccountSwitcher} {...props}>
      {adapterProps => (
        <div>
